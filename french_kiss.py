...
OPENROUTER_API_KEY = "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"
...
{yellow}                                                                                
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃French kiss - информационный агрегатор. Базы: 10 ТБ (публичные данные) + 17 ТБ (закрытые источники), 13 AI - специалистов       ┃
┃обученные по своим направлениям, интегрированные инструменты с Kali Linux. Использование - исключительно в исследовательских    ┃
┃целях. Ответственность лежит на пользователе.                                                                                   ┃
┃                                                                                                                                ┃
┃Доступные команды:                                                                                                              ┃
...
{gray}                                                                                                    (В РАЗРАБОТКЕ)
┌───────────────────────────────┬────────────────────────────────┬───────────────────────────────┬───────────────────────────────┐
│    ПРЯМОЙ ПОИСК ПО ДАМПАМ     │ ЮРИДИЧЕСКИЕ ЛИЦА И СТРУКТУРЫ   │        AI ИНСТРУМЕНТЫ         │      Pentest ИНСТРУМЕНТЫ      │
├───────────────────────────────┼────────────────────────────────┼───────────────────────────────┼───────────────────────────────┤
│ [1] Телефон (РФ, UA, KZ, UZ)  │ [14] Юр. лицо по ОГРН          │ [27] AI: OSINT разведка       │ [40] sqlmap                   │
│ [2] Email (все домены)        │ [15] Юр. лицо по ИНН           │ [28] AI: Python               │ [41] xss - injection          │
│ [3] ФИО (Ф, ФИ, ФИО)          │ [16] ИП по ОГРНИП              │ [29] AI: HTML/CSS/JS          │ [42] search vuln              │
│ [4] ИНН (физ/юр)              │ [17] ИП по ИНН                 │ [30] AI: SQL инъекции         │ [43] google dork              │
│ [5] СНИЛС                     │ [18] Физ. лицо по ИНН          │ [31] AI: XSS атаки            │ [44] parser web               │
│ [6] Госномер РФ               │ [19] Компании/ИП по ФИО        │ [32] AI: ИнфоБезопасность     │ [45] parser proxy             │
│ [7] Госномер UA               │ [20] Фин. отчётность по ОГРН   │ [33] AI: Кибербезопасность    │ [46] port scanner             │
│ [8] VIN                       │ [21] Фин. отчётность по ИНН    │ [34] AI: Криптография         │ [47] SSRF scanner             │
│ [9] IP-адрес                  │ [22] Госзакупки по ОГРН        │ [35] AI: Linux инструменты    │ [48] CSRF Exploit Builder     │
│ [10] Адрес                    │ [23] Госзакупки по ИНН         │ [36] AI: Серверы              │ [49] SSL/TLS Analyzer         │
│ [11] VK                       │ [24] Исп. производства по ОГРН │ [37] AI: Документы            │ [50] CMS Vulnerability Scan   │
│ [12] OK                       │ [25] Исп. производства по ИНН  │ [38] AI: Tor браузер          │ [51] SSH Brute Force          │
│ [13] FB                       │ [26] Банки по БИК              │ [39] AI: Соц. инженерия       │ [52] Hash Cracker             │
└───────────────────────────────┴────────────────────────────────┴───────────────────────────────┴───────────────────────────────┘
...
def main():
    ...
    while True:
        prompt = f"{red}╭─{yellow}[{white}root{orange}@{cyan}french-kiss{yellow}]{blue}─{purple}[{white}~{purple}]\n{red}╰─{white}$ {reset}"
